...
const socket = io.connect(`${window.location.protocol}//${window.location.hostname}:5005`, {path: "/socket.io", forceNew: true, reconnectionAttempts: 3, timeout: 2000, upgrades:["websocket"], pingTimeout:20000, ingInterval:25000});
